<template>
  <iep-dialog :dialog-show="dialogShow" :title="`${methodName}/扣减`" width="400px" @close="loadPage">
    <el-form :model="form" :rules="rules" size="small" ref="form" label-width="100px">
      <el-form-item label="金额：" prop="sum">
        <el-input v-model="form.sum"></el-input>
      </el-form-item>
      <el-form-item label="方式：" prop="resource">
        <el-radio-group v-model="form.resource" size="medium">
          <el-radio v-model="radio" label="1">打赏</el-radio>
          <el-radio v-model="radio" label="2">扣减</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="类型：" prop="typeId">
        <iep-dict-select v-model="form.typeId" dict-name="" placeholder="选择类型"></iep-dict-select>
      </el-form-item>
