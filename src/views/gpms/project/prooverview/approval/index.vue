        ...
        <basic-container>
            ...
            <iep-tabs v-model="activeTab" :tab-list="tabList">
                ...
                <template v-if="activeTab ==='Accredit'" v-slot:Accredit>
                    <accredit
                        v-loading="activeTab !=='Accredit'"
                        :isShow="addDialogShow"
                        :detailShow="detailDialogShow"
                        @detail-show="fn"
                        @toggle-show="val => addDialogShow = val"></accredit>
                </template>
            </iep-tabs>
...
<script>
    ...
    export default {
        components: { PageHeader, IepTabs, ProApp, Accredit, addDialog, detailDialog },
        data () {
            return {
                addDialogShow: false,
