  ...
  methods: {
    open (id) {
      getDataById(id).then((res) => {
        ...
        data.companyRealName = `${data.companyName.name} - ${data.companyName.orgName}`
        data.signCompanyName = `${data.signCompanyRealName.name} - ${data.signCompanyRealName.orgName}`
