...
export default {
  ...
  methods: {
    initApi () {
      ...
      //     return {
      //       value: item.id,
      //       label: '【'+getStatus(item.status) + '】' + item.projectName,
      //     }
      //   })
      //
      //   this.projectIdDic = dic
      //   if(dic.length > 0){
      //     this.projectId = dic[0].value
      //     this.currentStage = 0
      //     this.changeProject(dic[0].value)
      //     this.handleClick({
      //       name: this.activeName,
      //     })
      //   }
      //   // console.log("hahah",this.projectIdDic)
      // })
