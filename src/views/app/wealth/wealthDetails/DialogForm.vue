        ...
        <div class="right">
          <el-scrollbar style="height:300px;" v-if="choose=='one'">
            <div style="padding-right:10px;">
              ...
              <p>二、激励形式</p>
              <p>本次激励计划通过采取虚拟股股权授予形式开展，激励对象通过出资即可享有公司根据业绩情况给予的一定比例的拟制分红权（分红权实现形式为由公司发放与虚拟股权收益金额相等的奖励）。且虚拟股没有表决权和继承权，只有拟制分红权和转让权。</p>
              <p>三、激励数量</p>
              <p>员工购买组织虚拟股最高数量不设限制，直到股权售完即止。</p>
              <p>四、股权生效</p>
              ...
              <p>八.解释、修改和终止</p>
              <p>1.本计划的解释权属于集团董事（会）。</p>
              <p>2.公司董事（会）可以随时修改、中止或终止本计划，但准备进行的修改、中止或终止不能实质影响合格认购人员在该修改、中止或终止进行以前已得到的或预期得到的经济利益；且任何修改、中止或终止需提供书面材料。</p>
            </div>
          </el-scrollbar>
