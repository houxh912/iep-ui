    ...
    <div class="box">
      ...
      <div>
        <h4>
          ...
          <el-select v-if="state1 && editable" size="small" style="width:200px!important" v-model="work.problemProperties" placeholder="请选择">
            <el-option
              v-for="item in getDic('EVA_PROBLEM_PROPERRIES')"
              :key="item.value"
              :label="item.label"
              :value="item.value">
            </el-option>
      ...
      <div>
        <h4>
          问题发现时间：
          <el-date-picker
            v-if="state1  && editable"
            v-model="work.problemDiscoveryTime"
            type="datetime"
            style="width:200px"
      ...
      <div>
        <h4>
          ...
          <el-date-picker
            v-if="state1  && editable"
            v-model="work.rectificationPeriod"
            type="datetime"
            value-format="yyyy-MM-dd HH:mm:ss"
            style="width:200px"
            placeholder="选择日期">
      ...
      <div>
        <h4>
          评测说明以及建议：
          <gov-froala-editor v-if="state1  && editable" v-model="work.reviewInstructions"></gov-froala-editor>
          <gov-froala-editor-detail v-else :htmlStr="formData.reviewInstructions"></gov-froala-editor-detail>
