  ...
  <div>
    ...
    <div class="examShow">
      <div style="float: left; width: 70%;">
        ...
        <span style="font-size: 15px;margin-left: 25px;">共 {{questionTypeOneTotal}} 题，合计 {{questionTypeOneScore}} 分，已完成 {{questionTypeOnePer}} / {{questionTypeOneTotal}}</span>
        <hr>
        ...
        <div style="margin-top: 15px;font-size: 15px;">
          ...
          <div>
            <li
              v-for="(item,index) in fieldList" :key="index" style="list-style-type:none;">
          ...
          <div>
            <el-checkbox-group v-model="checksList" style="margin-left: 28px;">
              <el-checkbox style="margin-right: 100%;" v-for="item in checkboxList" :label="item.option" :key="item.option" @change="handleCheckBox ()">
