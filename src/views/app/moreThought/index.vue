...
import { geTallPage, CommentThoughts, addThumbsUpByRecord, getThumbMembers } from '@/api/cpms/thoughts'
...
export default {
  components: { headTpl, commentTpl, PublishDialog, contentTpl, forwardDialog, forwardContent, rightTpl },
  data () {
    return {
      isShow: true,
      routerMatch: [
