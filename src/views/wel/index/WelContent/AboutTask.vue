  ...
  data () {
    return {
      ...
      content: {
        ...
        approval: [{ title: '关于20190129微接全流程管理项目分享》的通知', author: '崔颖', date: '01-30' }, { title: '关于规范国脉社群管理及相', author: '崔颖', date: '01-30' }, { title: '关于20190126微信优秀项目分享《2018版浙江目录梳理项目经验分享》的通知', author: '崔颖', date: '01-30' }, { title: '关于发布市场开发与产品销售情况调研的通知', author: '邵万炯', date: '01-30' }, { title: '关于发布《国脉集团项目质量管理)的通知', author: '崔颖', date: '01-30' }],
      },
