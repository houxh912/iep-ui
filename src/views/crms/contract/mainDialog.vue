<template>
  <iep-dialog :dialog-show="dialogShow" :title="`${methodName}合同`" width="60%" @close="resetForm('form')">
    <el-form :model="formData" :rules="rules" ref="form" label-width="100px">
        ...
        <el-row>
          <el-col :span=12>
            <el-form-item label="委托单位：" prop="deptId1">
              <el-input v-model="formData.deptId1" placeholder="委托单位"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span=12>
            <el-form-item label="签署单位：" prop="deptId2">
              <el-input v-model="formData.deptId2" placeholder="签署单位"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span=12>
            <el-form-item label="签署部门：" prop="deptId3">
              <el-input v-model="formData.deptId3" placeholder="签署部门"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span=12>
            <el-form-item label="承接部门：" prop="deptId4">
              <el-input v-model="formData.deptId4" placeholder="承接部门"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
      ...
      <el-row class="detail" v-if="methodState">
...
import { initFormData, rules } from './const'
import iepTags from '@/components/IepTags'
export default {
  components: { IepDialog, DetailContent, iepTags },
  data () {
    return {
      formData: {
        biaoqian: ['标签1号'],
