<template>
  <el-form class="login-form" status-icon :rules="rules" ref="form" :model="form" label-width="0">
    <el-form-item prop="phone">
      <a-input ref="phone" v-model="form.phone" autocomplete="username" placeholder="请输入手机号码" size="large" :disabled="!!$route.query.quick">
    ...
    <el-form-item prop="realName">
      <a-input ref="realName" v-model="form.realName" autocomplete="name" placeholder="请输入真实姓名（可选）" size="large">
