  ...
  <div>
    <div class="examExamine-wrapper">
      <el-card shadow="never" class="examExamine-elCard" v-loading="loading">
        <div slot="header" class="examExamine-header">
        ...
        <el-container class="examExamine-container">
          <div class="examExamine-main">
            <div v-if="radioMap.length>0" class="question-content">
            ...
            <div v-if="checkboxMap.length>0" class="question-content">
            ...
            <div v-if="checkedMap.length>0" class="question-content">
            ...
            <div v-if="textMap.length>0" class="question-content">
          ...
          <el-aside width="25%" class="examExamine-aside">
            <div class="responseCard">
              ...
              <div class="content" v-if="radioMap.length>0">
                ...
                <div class="questionMark">
                  <a class="choices" v-for="(radioItem,index) in radioMap" :key="index+1" :href="'#radio_'+(index+1)"
                    :style="radioItem.userAnswer===radioItem.itemAnswer ? successBgColor:errorBgColor">{{index+1}}</a>
                </div>
              </div>

              <div class="content" v-if="checkboxMap.length>0">
                <div class="questionTitle">
                  <span>复选题</span>
                ...
                <div class="questionMark">
                  <a class="choices" v-for="(checkboxItem,index) in checkboxMap" :key="index+1"
                    :href="'#checkbox_'+(index+1)" :style="checkboxItem.userAnswer===checkboxItem.itemAnswer ? successBgColor:errorBgColor">{{index+1}}</a>
                </div>
              </div>

              <div class="content" v-if="checkedMap.length>0">
                <div class="questionTitle">
                  <span>判断题</span>
                ...
                <div class="questionMark">
                  <a class="choices" v-for="(checkedItem,index) in checkedMap" :key="index+1" :href="'#checked_'+(index+1)"
                    :style="checkedItem.userAnswer===checkedItem.itemAnswer ? successBgColor:errorBgColor">{{index+1}}</a>
                </div>
              </div>

              <div class="content" v-if="textMap.length>0">
                <div class="questionTitle">
                  <span>简答题</span>
...
.question-content >>> .el-radio__input.is-disabled .el-radio__inner,
.question-content >>> .el-checkbox__input.is-disabled .el-checkbox__inner {
  background-color: #ffffff;
  border-color: #dcdfe6;
}
.question-content >>> .el-radio__input.is-disabled + span.el-radio__label,
.question-content
  >>> .el-checkbox__input.is-disabled
  + span.el-checkbox__label {
  color: #606266;
}
.footer >>> .el-checkbox:first-child .el-checkbox__inner {
  background-color: #64ad42;
}
.footer >>> .el-checkbox:last-child .el-checkbox__inner {
