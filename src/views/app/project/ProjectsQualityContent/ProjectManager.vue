  ...
  data () {
    return {
      ...
      projectManagerList: [
        ...
        { img: '../img/person/p07.jpg', name: '张兵', department: '国脉集团研发中心', num: '执行项目（1个）' },
        { img: '../img/person/p08.jpg', name: '何舟杰', department: '国脉先锋队', num: '执行项目（3个）' },
        { img: '../img/person/p09.jpg', name: '潘超巧', department: '国脉先锋队', num: '执行项目（4个）' },
      ],
    }
  },
  methods: {
