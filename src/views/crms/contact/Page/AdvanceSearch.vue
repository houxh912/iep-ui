  ...
  <div>
    <el-form :model="form" label-width="100px" size="small">
      ...
      <el-form-item label="对应客户">
        ...
        <el-autocomplete class="inline-input" v-model="form.clientName" :fetch-suggestions="querySearch" placeholder="请输入对应客户" @select="handleSelect" :hide-loading="isLoading" :trigger-on-focus="false"></el-autocomplete>
