        ...
        <el-form :model="paramForm" :rules="rules" ref="ruleForm3">
            ...
            <div>
              ...
              <div class="workType">
                <el-select v-if="!isElse" v-model="paramForm.workType.type2" placeholder="请选择业务类型">
                  <el-option v-for="item in workTypeTwoOK" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
          ...
          <el-form-item label="是否关联产品:" prop="isUse">
            <el-select @change="change" v-model="paramForm.isUse" placeholder="请选择是否关联产品">
              <el-option v-for="item in isRelevOptions" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>
          <!--相关产品-->
