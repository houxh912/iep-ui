<template>
  <div class="account-wrapper">
    <div class="user-simple-box">
      ...
      <el-tooltip effect="dark" content="资料完善度" placement="bottom">
        <el-progress :percentage="form.integrity" :stroke-width="8" color="#55b956"></el-progress>
      </el-tooltip>
    </div>
        ...
        <div class="user-position-operation-box">
          ...
          <div class="user-operation-box">
            <div class="operation-box-con">
              ...
              <iep-button v-if="permissions.wel_leadership_desktop" class="leader-btn" type="primary" icon="el-icon-monitor" plain @click="handleSome2()">领导桌面</iep-button>
            </div>
