<template>
  <div class="wel-content">
    ...
    <a-modal title="欢迎您加盟国脉我能智慧平台" v-model="visible">
      <p>欢迎登录国脉我能智慧平台，我们将为您提供工作、学习、（自我）管理、协作、个人财富增值和服务创新等一系列服务，将为你的工作与学习带来系列惊喜的变化。请您准确、全面填写好相关信息，了解好平台运营规则，学习新生必读相关材料。本平台是我能资源的汇聚与分享，许多材料和功能限于您个人使用，请注意保密，保管好您的账号密码和财富。</p>
